...
CREATE TABLE `IndustrySurveys` (
  ...
  `公司名字` varchar(255) COLLATE utf8mb4_unicode_ci,
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `贵公司员工数量` INTEGER COLLATE utf8mb4_unicode_ci,
  `贵公司员工平均年龄约` INTEGER COLLATE utf8mb4_unicode_ci,
  `贵公司成立时间` varchar(255) COLLATE utf8mb4_unicode_ci,  
  `贵公司规模` varchar(255) COLLATE utf8mb4_unicode_ci,
  `已成立组织` varchar(255) COLLATE utf8mb4_unicode_ci,
  `组织活动频次` varchar(255) COLLATE utf8mb4_unicode_ci,
  `组织什么活动` varchar(255) COLLATE utf8mb4_unicode_ci,
  `意向成立组织` varchar(255) COLLATE utf8mb4_unicode_ci,
  `了解组织要求` varchar(255) COLLATE utf8mb4_unicode_ci,
  `公司活动` varchar(255) COLLATE utf8mb4_unicode_ci,
  `其他公司活动` varchar(500) COLLATE utf8mb4_unicode_ci,
  `帮助成立组织` varchar(255) COLLATE utf8mb4_unicode_ci,
  `组织活动困难` varchar(255) COLLATE utf8mb4_unicode_ci,
  `其他组织活动困难` varchar(500) COLLATE utf8mb4_unicode_ci,
  `了解党群服务` varchar(255) COLLATE utf8mb4_unicode_ci,
  `公司需要的支持` varchar(255) COLLATE utf8mb4_unicode_ci,
  `其他公司需要的支持` varchar(500) COLLATE utf8mb4_unicode_ci,  
  `给团队支持` varchar(255) COLLATE utf8mb4_unicode_ci,
  `其他给团队支持` varchar(500) COLLATE utf8mb4_unicode_ci,  
  `近来办理的事项` varchar(255) COLLATE utf8mb4_unicode_ci,
  `近来政府机办理的业务` varchar(255) COLLATE utf8mb4_unicode_ci,
  `政府机每次时间` varchar(255) COLLATE utf8mb4_unicode_ci,
  `对设立综合业务窗口的看法` varchar(255) COLLATE utf8mb4_unicode_ci,
  `其他对设立综合业务窗口的看法` varchar(500) COLLATE utf8mb4_unicode_ci,  
  `希望政务帮助` varchar(500) COLLATE utf8mb4_unicode_ci,
  `其他希望政务帮助` varchar(500) COLLATE utf8mb4_unicode_ci,  
